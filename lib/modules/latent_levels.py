...
class FullyConnectedLatentLevel(nn.Module):
    ...
    def inference_parameters(self):
        ...
        if self.det_enc:
            encoder_params.extend(list(self.det_enc.parameters()))
        encoder_params.extend(list(self.latent.inference_parameters()))
    ...
    def generative_parameters(self):
        ...
        if self.det_dec:
            decoder_params.extend(list(self.det_dec.parameters()))
        decoder_params.extend(list(self.latent.generative_parameters()))
...
class ConvolutionalLatentLevel(nn.Module):
    ...
    def inference_model_parameters(self):
        ...
        if self.det_enc:
            encoder_params.extend(list(self.det_enc.parameters()))
        encoder_params.extend(list(self.latent.inference_model_parameters()))
        return encoder_params
    ...
    def generative_model_parameters(self):
        ...
        if self.det_dec:
            decoder_params.extend(list(self.det_dec.parameters()))
        decoder_params.extend(list(self.latent.generative_model_parameters()))
        return decoder_params
